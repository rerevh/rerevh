<section class="panel panel-faster">
	<div>
        ...
        <div class="tab-content">
            <table class="table table-bordered table-striped table-form " id="table-view-activity-submit" 
            	data-url='Plan/Input_activity/activity_budget_submited' style='width:100% !important;''>
                <thead>
                    <tr>
                        <th>No.</th>
