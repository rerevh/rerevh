<section class="panel panel-faster">
	<div>
        ...
        <div class="tab-content">
            <table class="table table-bordered table-striped table-form " id="table-view-activity-reject" 
            	data-url='Plan/Input_activity/activity_budget_rejected' style='width:100% !important;''>
                <thead>
                    <tr>
                        <th>No.</th>
