	...
	<div class="col-md-12 col-lg-12 col-xl-12">
		<section class="panel">
			<div class="panel-body" style="border: 0px solid #232;">
				...
				<a href="<?php echo base_url('plan/input-activity');?>" class="col-sm-12 mb-xs mt-xs mr-xs btn btn-lg btn-primary"><i class=" fa-2x fa fa-registered"></i><br/><h6><br/>Input Activity</h6></a>
				</div>
				<div class="col-md-2" style="border: 0px solid #232; padding-left: 5px; padding-right: 5px;">
				<a href="<?php echo base_url('plan/input-activity/detail-budget') ?>" class="col-sm-12 mb-xs mt-xs mr-xs btn btn-lg btn-primary"><i class=" fa-2x fa fa-registered"></i><br/><h6><br/>Input Budget</h6></a>
				</div>
<!--				<div class="col-md-2" style="border: 0px solid #232; padding-left: 5px; padding-right: 5px;">
				<a href="<?php echo base_url('Approve') ?>" class="col-sm-12 mb-xs mt-xs mr-xs btn btn-lg btn-primary"><i class=" fa-2x fa fa-balance-scale"></i><br/><h6>Approve/<br/>Reject</h6></a>
				</div>
				<div class="col-md-2" style="border: 0px solid #232; padding-left: 5px; padding-right: 5px;">
				<a href="<?php echo base_url('Quotation') ?>" class="col-sm-12 mb-xs mt-xs mr-xs btn btn-lg btn-primary"><i class=" fa-2x fa fa-bullhorn"></i><br/><h6><br/>Quotation</h6></a>
				</div>
				<div class="col-md-2" style="border: 0px solid #232; padding-left: 5px; padding-right: 5px;">
				<a href="<?php echo base_url('Memo') ?>" class="col-sm-12 mb-xs mt-xs mr-xs btn btn-lg btn-primary"><i class=" fa-2x fa fa-sticky-note-o"></i><br/><h6>Selection<br/>Memo</h6></a>
				</div>
				<div class="col-md-2" style="border: 0px solid #232; padding-left: 5px; padding-right: 5px;">
				<a href="<?php echo base_url('Po') ?>" class="col-sm-12 mb-xs mt-xs mr-xs btn btn-lg btn-primary"><i class=" fa-2x fa fa-calendar"></i><br/><h6>Purchase<br/>Order</h6></a>
				</div>
				<div class="col-md-2" style="border: 0px solid #232; padding-left: 5px; padding-right: 5px;">
				<a href="<?php echo base_url('Inventories/lists') ?>" class="col-sm-12 mb-xs mt-xs mr-xs btn btn-lg btn-primary"><i class=" fa-2x fa fa-navicon"></i><br/><h6>Inventory<br/>List</h6></a>
				</div>
				<div class="col-md-2" style="border: 0px solid #232; padding-left: 5px; padding-right: 5px;">
				<a href="<?php echo base_url('Vendor') ?>" class="col-sm-12 mb-xs mt-xs mr-xs btn btn-lg btn-primary"><i class=" fa-2x fa fa-ambulance"></i><br/><h6>Vendor/<br/>Supplier</h6></a>
				</div>
				<div class="col-md-2" style="border: 0px solid #232; padding-left: 5px; padding-right: 5px;">
				<a href="<?php echo base_url('Users') ?>" class="col-sm-12 mb-xs mt-xs mr-xs btn btn-lg btn-primary"><i class=" fa-2x fa fa-user"></i><br/><h6>User/<br/>Staff<br/></h6></a>
				</div>
				<div class="col-md-2" style="border: 0px solid #232; padding-left: 5px; padding-right: 5px;">
				<a href="<?php echo base_url('Dashboard/Settings') ?>" class="col-sm-12 mb-xs mt-xs mr-xs btn btn-lg btn-primary"><i class=" fa-2x fa fa-gears"></i><br/><h6>Options/<br/>Settings<br/></h6></a>
				</div>-->
