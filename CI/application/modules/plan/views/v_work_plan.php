<section role="main" class="content-body">
    ...
    <section class="panel">
        <header class="panel-heading" style=" border: 1px solid #5B707B; padding: 10px 14px; background: #5B707B;">
            <h2 class="panel-title" style="font-size: medium; color: white;"><i class="fa fa-chevron-right"> </i> Work Plan</h2>
        </header>
        <div>
...
<script>
    $(document).ready(function() {
        ...
        $(document).on('change', '#filter_year', function(ee) {
            ...
            tabel_filter(year, lokasi, group);
        });
        $(document).on('change', '#filter_lokasi', function(ee) {
            var year = $("#filter_year").val();
            var lokasi = $(this).val();
            var group = $("#filter_group").val();
            tabel_filter(year, lokasi, group);
        });
        $(document).on('change', '#filter_group', function(ee) {
            var year = $("#filter_year").val();
            var lokasi = $("#filter_lokasi").val();
            var group = $("#filter_group").val();
            tabel_filter(year, lokasi, group);
        ...
        $(document).on('change', '#filter_year', function(ee) {
            ...
            $.ajax({
                type: "POST",
                url: BASE_URL + "index.php/Plan/work_plan/tabel",
                data: {
                    param: param
                },
        ...
        $(document).on('click', '#btn_save', function(ee) {
            ...
            $.ajax({
                url: BASE_URL + "index.php/Plan/work_plan/simpan",
                data: formData,
    ...
    function filter() {
        $.ajax({
            type: "POST",
            url: BASE_URL + "index.php/Plan/work_plan/filter",
            beforeSend: function(jqXHR, setting) {
    ...
    function tabel_filter(year, lokasi, group) {
        $.ajax({
            type: "POST",
            url: BASE_URL + "index.php/Plan/work_plan/tabel",
            data: {
    ...
    function form(id) {
        $.ajax({
            type: "POST",
            url: BASE_URL + "index.php/Plan/work_plan/form",
            data: {
                id: id
            },
            beforeSend: function(jqXHR, setting) {
    ...
    function reason(id) {
        $.ajax({
            type: "POST",
            url: BASE_URL + "index.php/Plan/work_plan/alasan",
            data: {
                id: id
            },
            beforeSend: function(jqXHR, setting) {
    ...
    function postponse(id) {
        $.ajax({
            type: "POST",
            url: BASE_URL + "index.php/Plan/work_plan/postponse",
            data: {
                id: id
            },
            beforeSend: function(jqXHR, setting) {
    ...
    function save_status_update(id_status_update, status_update, reason, month) {
        ...
        $.ajax({
            url: BASE_URL + "index.php/Plan/work_plan/save_status_update",
            data: {
    ...
    function save() {
        ...
        $.ajax({
            url: BASE_URL + "index.php/Plan/work_plan/save",
    ...
    function proses_edit() {
        ...
        $.ajax({
            url: BASE_URL + "index.php/Plan/work_plan/proses_edit",
            data: $('#submit').serialize(),
            type: "POST",
            dataType: "json",
            beforeSend: function() {
    ...
    function del(id) {
        $.ajax({
            url: BASE_URL + "index.php/Plan/work_plan/delete",
            data: {
                id: id
            },
            type: "POST",
