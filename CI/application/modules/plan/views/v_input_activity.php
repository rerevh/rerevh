	...
	<header class="page-header">
		...
		<div class="right-wrapper pull-right">
			<ol class="breadcrumbs">
				...
				<li><span>Input Activity</span></li>
            </ol>
		...
		<section class="panel">
			<header class="panel-heading" style=" border: 1px solid #5B707B; padding: 10px 14px; background: #5B707B;">
				<h2 class="panel-title" style="font-size: medium; color: white;"><i class="fa fa-chevron-right"> </i> Input Activity</h2>
			</header>
			   <div>
...
$(document).ready(function() 
{
    ...
    $(document).on('click','.cancel',function(ee){
     ...
     $(document).on('click','#btn_save',function(ee){
             ...
             $.ajax({
                 url: BASE_URL+"index.php/Plan/Input_activity/simpan",
                 data: formData,
...
function tabel()
{
        $.ajax({
                    type: "POST",
                    url : BASE_URL+"index.php/Plan/Input_activity/tabel",
...
function form()
{
        $.ajax({
                    type: "POST",
                    url : BASE_URL+"index.php/Plan/Input_activity/form",
                    beforeSend : function(jqXHR,setting)
                    {
...
function save()
{
    ...
    $.ajax({
         url: BASE_URL+"index.php/Plan/Input_activity/save",
...
function proses_edit()
{
    ...
    $.ajax({
         url: BASE_URL+"index.php/Plan/Input_activity/proses_edit",
         data: $('#submit').serialize(),
         type: "POST",
         dataType : "json",
         beforeSend: function() {
...
function edit(id,kode_kegiatan)
{
...
{
    $.ajax({
               url : BASE_URL+"index.php/Plan/Input_activity/delete",
               data: 
                       {
                           id:id
                       },
