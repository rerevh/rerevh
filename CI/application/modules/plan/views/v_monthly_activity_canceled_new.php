<section class="panel panel-faster">
    <div>
        ...
        <div class="tab-content">
            <table class="table table-bordered table-striped table-form " id="table-cancelled"
                data-url='plan/monthly-activity/canceled'>
                <thead>
                    <tr>
                        <th>No.</th>
                        <th>Code Activity</th>
...
<script>
    document.onreadystatechange = function () {
        if (document.readyState == 'complete') {
            var table = new getDataTable(null, "table-cancelled");
        }
    }
</script>