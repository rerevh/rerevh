...
class Monthly_activity_postponed extends Backend{
   ...
   function index(){
      if(ajax()==true){
         ...
         END) as bulan,
         (CASE 
            WHEN a.month_postponse="1" THEN "Jan"
            WHEN a.month_postponse="2" THEN "Feb"
            WHEN a.month_postponse="3" THEN "Mar"
            WHEN a.month_postponse="4" THEN "Apr"
            WHEN a.month_postponse="5" THEN "Mei"
            WHEN a.month_postponse="6" THEN "Jun"
            WHEN a.month_postponse="7" THEN "Jul"
            WHEN a.month_postponse="8" THEN "Agt"
            WHEN a.month_postponse="9" THEN "Sep"
            WHEN a.month_postponse="10" THEN "Okt"
            WHEN a.month_postponse="11" THEN "Nov"
            WHEN a.month_postponse="12" THEN "Des"
         END) as bulan_postponse,
         ...
         $this->datatable->edit_column('act',
         "<a href='javascript:;' class='edit btn  btn-faster btn-block' id='$1'> Set Status <i class='fa fa-hand-pointer-o'></i> </a>"
         ,'get_url_encode(act)');
         ...
         $this->template('v_monthly_activity_postponed');
      }
   }
