...
;(function ($, window, document, undefined) {
  ...
  BootstrapDualListbox.prototype = {
    init: function () {
      ...
      this.container = $('' +
        '<div class="bootstrap-duallistbox-container2">' +
        ...
        ' <div>&nbsp;' +  
        ' </div>' +                     
        ' <div class="box1 box2" style="padding: 60px 0; ">' +        
        
        '   <div class="buttons">' +
        '     <button type="button" class="btn moveall mt-3 mb-3 text-white" style="background-color: #ff5053;">' +
        '       <i></i>' +
        '       <i></i>' +
        '     </button>' +
        ...
        '       <i></i>' +
        '     </button>' +
        '     <button type="button" class="btn removeall mb-3 text-white" style="background-color: #ff5053;">' +
        '       <i></i>' +
        '       <i></i>' +
        '     </button>' +
        '   </div>' +             
